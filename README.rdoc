...
+acts_as_audited+ works with Rails 3.0.3 and Rails 3.0.4. For older versions of Rails, please see the <tt>1.1-stable</tt> branch.
...
To run with JRuby, run your specs as follows:

  $ bundle exec rake spec test DB=JRUBYSQLITE3MEM
